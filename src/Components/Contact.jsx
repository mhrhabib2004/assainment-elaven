...
const Contact = () => {
    return (
        <section className="bg-white mt-7 dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        <div>
            <p className="font-bold md:text-4xl text-center text-blue-500 dark:text-blue-400">Contact us</p>

            <h1 className="mt-4 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Chat to our friendly team</h1>
